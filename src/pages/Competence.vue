<template>
    ...
    <section id="skills" class="py-10 bg-slate-900 text-white">
        ...
        <div id="skills-container" class="grid md:grid-cols-2 grid-cols-1 gap-6 md:px-10 p-3">
            ...
            <div id="programing-langage" class="border border-gray-700 rounded-lg p-5" data-aos="fade-up">
                <p class="p-3 text-lg font-medium flex items-center gap-2">
                    <i class="fa fa-code"></i>
                    Langages de Programmation
                </p>
                <div class="grid grid-cols-3 gap-10 p-5 place-content-center">
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
            ...
            <div id="frameworks" class="border border-gray-700 rounded-lg p-5" data-aos="fade-up" data-aos-delay="100">
                <p class="p-3 text-lg font-medium flex items-center gap-2">
                ...
                <div class="grid grid-cols-3 gap-10 p-5 place-content-center">
                    ...
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
                        <img src="../assets/bootstrap.svg" alt="Bootstrap5" />
                        <p>Bootstrap5</p>
                    </button>
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
            ...
            <div id="programing-tools" class="border border-gray-700 rounded-lg p-5" data-aos="fade-up"
                data-aos-delay="200">
                <p class="p-3 text-lg font-medium flex items-center gap-2">
                    <i class="fa fa-server"></i>
                    Outils de développement et base de donnée
                </p>
                <div class="grid grid-cols-3 gap-10 p-5 place-content-center">
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
                    ...
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
                        <img src="../assets/vs-code.svg" alt="VSCode" />
                        <p>VSCode</p>
                    </button>
                    <button
                        class="w-[70px] hover:-translate-y-2 duration-300 cursor-pointer flex justify-center items-center flex-col gap-1">
